    def load_daily_stats_data(self):
        ...
        try:
            ...
            header.setSectionResizeMode(1, QHeaderView.ResizeMode.Stretch)  # 公民身份证号码列
            ...
            header.setSectionResizeMode(9, QHeaderView.ResizeMode.ResizeToContents)  # 思想列
            ...
            header.setSectionResizeMode(14, QHeaderView.ResizeMode.Stretch)  # 其他列
