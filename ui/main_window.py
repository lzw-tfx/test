...
class MainWindow(QMainWindow):
    ...
    def create_navigation(self):
        ...
        half_year_label.setAlignment(Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignVCenter)
    ...
    def create_basic_info_tab(self):
        ...
        self.search_table.horizontalHeader().setDefaultAlignment(Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignVCenter)
    ...
    def create_exception_statistics_tab(self):
        ...
        header.setSectionResizeMode(1, QHeaderView.ResizeMode.ResizeToContents)  # 姓名列
        header.setSectionResizeMode(2, QHeaderView.ResizeMode.ResizeToContents)  # 日期列
        header.setSectionResizeMode(3, QHeaderView.ResizeMode.ResizeToContents)  # 公民身份号码列
        header.setSectionResizeMode(4, QHeaderView.ResizeMode.ResizeToContents)  # 性别列
        header.setSectionResizeMode(5, QHeaderView.ResizeMode.ResizeToContents)  # 应征地列
        header.setSectionResizeMode(6, QHeaderView.ResizeMode.ResizeToContents)  # 连列
        header.setSectionResizeMode(7, QHeaderView.ResizeMode.ResizeToContents)  # 排列
        header.setSectionResizeMode(8, QHeaderView.ResizeMode.ResizeToContents)  # 班列
        header.setSectionResizeMode(9, QHeaderView.ResizeMode.ResizeToContents)  # 带训班长信息列
        header.setSectionResizeMode(10, QHeaderView.ResizeMode.ResizeToContents)  # 思想列
        header.setSectionResizeMode(11, QHeaderView.ResizeMode.ResizeToContents)  # 身体列
        header.setSectionResizeMode(12, QHeaderView.ResizeMode.ResizeToContents)  # 精神列
        header.setSectionResizeMode(13, QHeaderView.ResizeMode.ResizeToContents)  # 训练列
        header.setSectionResizeMode(14, QHeaderView.ResizeMode.ResizeToContents)  # 管理列
        header.setSectionResizeMode(15, QHeaderView.ResizeMode.ResizeToContents)  # 其他列（异常来源）
        header.setSectionResizeMode(16, QHeaderView.ResizeMode.ResizeToContents)  # 操作列
    ...
    def display_detailed_results(self, results):
        ...
        for row, data in enumerate(results):
            ...
            # 表头顺序（从第2列开始）：
            # 序号, 姓名, 公民身份号码, 性别, 出生日期, 民族, 政治面貌, 宗教信仰, 籍贯,
            # 文化程度, 学业情况, 学习类型, 入营时间, 应征地, 经常居住地址, 户籍所在地, 邮编,
            # 本人电话, 家庭电话, 毕业(就读)学校, 所学专业, 入学时间,
            # 初检医院, 初检结论, 初检时间, 体检结论, 体检时间, 体检不合格原因, 主检医师意见, 毕业时间,
            ...
            view_btn_layout.setAlignment(Qt.AlignmentFlag.AlignCenter)
    ...
    def batch_add_daily_info(self):
        """批量添加每日情况统计信息"""
        try:
            from PyQt6.QtWidgets import QDialog, QVBoxLayout, QHBoxLayout, QLabel, QPushButton, QDateEdit, QComboBox, QTextEdit
            from PyQt6.QtCore import QDate
    ...
    def edit_daily_record(self, record_id, youth_id):
        """修改每日记录"""
        try:
            from PyQt6.QtWidgets import QDialog, QVBoxLayout, QHBoxLayout, QLabel, QLineEdit, QPushButton, QDateEdit, QComboBox, QFormLayout
            from PyQt6.QtCore import QDate
    ...
    def create_medical_screening_tab(self):
        ...
        header.setSectionResizeMode(QHeaderView.ResizeMode.Interactive)  # 允许手动调整
        header.setSectionResizeMode(0, QHeaderView.ResizeMode.ResizeToContents)  # 选择列
        header.setSectionResizeMode(1, QHeaderView.ResizeMode.ResizeToContents)  # 姓名列
        header.setSectionResizeMode(2, QHeaderView.ResizeMode.ResizeToContents)  # 性别列
        header.setSectionResizeMode(3, QHeaderView.ResizeMode.ResizeToContents)  # 身份证列
        header.setSectionResizeMode(4, QHeaderView.ResizeMode.ResizeToContents)  # 应征地列
        header.setSectionResizeMode(5, QHeaderView.ResizeMode.ResizeToContents)  # 连列
        header.setSectionResizeMode(6, QHeaderView.ResizeMode.ResizeToContents)  # 排列
        header.setSectionResizeMode(7, QHeaderView.ResizeMode.ResizeToContents)  # 班列
        header.setSectionResizeMode(8, QHeaderView.ResizeMode.ResizeToContents)  # 带训班长信息列
        header.setSectionResizeMode(9, QHeaderView.ResizeMode.Stretch)  # 筛查情况列自动拉伸
        header.setSectionResizeMode(10, QHeaderView.ResizeMode.ResizeToContents)  # 筛查日期列
        header.setSectionResizeMode(11, QHeaderView.ResizeMode.ResizeToContents)  # 备注列
        header.setSectionResizeMode(12, QHeaderView.ResizeMode.ResizeToContents)  # 身体状况列
        header.setSectionResizeMode(13, QHeaderView.ResizeMode.ResizeToContents)  # 精神状况列
        header.setSectionResizeMode(14, QHeaderView.ResizeMode.ResizeToContents)  # 操作列
        header.setSectionResizeMode(15, QHeaderView.ResizeMode.ResizeToContents)  # 删除列
    ...
    def create_daily_stats_tab(self):
        ...
        header.setSectionResizeMode(QHeaderView.ResizeMode.Interactive)  # 允许手动调整
        header.setSectionResizeMode(0, QHeaderView.ResizeMode.ResizeToContents)  # 选择列
        header.setSectionResizeMode(1, QHeaderView.ResizeMode.ResizeToContents)  # 公民身份号码列
        header.setSectionResizeMode(2, QHeaderView.ResizeMode.ResizeToContents)  # 姓名列
        header.setSectionResizeMode(3, QHeaderView.ResizeMode.ResizeToContents)  # 应征地列
        header.setSectionResizeMode(4, QHeaderView.ResizeMode.ResizeToContents)  # 连列
        header.setSectionResizeMode(5, QHeaderView.ResizeMode.ResizeToContents)  # 排列
        header.setSectionResizeMode(6, QHeaderView.ResizeMode.ResizeToContents)  # 班列
        header.setSectionResizeMode(7, QHeaderView.ResizeMode.ResizeToContents)  # 带训班长信息列
        header.setSectionResizeMode(8, QHeaderView.ResizeMode.ResizeToContents)  # 日期列
        header.setSectionResizeMode(9, QHeaderView.ResizeMode.Stretch)  # 思想列自动拉伸
        header.setSectionResizeMode(10, QHeaderView.ResizeMode.ResizeToContents)  # 身体列
        header.setSectionResizeMode(11, QHeaderView.ResizeMode.ResizeToContents)  # 精神列
        header.setSectionResizeMode(12, QHeaderView.ResizeMode.ResizeToContents)  # 训练列
        header.setSectionResizeMode(13, QHeaderView.ResizeMode.ResizeToContents)  # 管理列
        header.setSectionResizeMode(14, QHeaderView.ResizeMode.ResizeToContents)  # 其他列
        header.setSectionResizeMode(15, QHeaderView.ResizeMode.ResizeToContents)  # 修改列
        header.setSectionResizeMode(16, QHeaderView.ResizeMode.ResizeToContents)  # 删除列
        header.setStretchLastSection(False)
        header.setDefaultAlignment(Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignVCenter)
    ...
    def display_daily_stats_data(self, results):
        ...
        try:
            ...
            for row, data in enumerate(results):
                ...
                edit_btn_layout.setAlignment(Qt.AlignmentFlag.AlignCenter)
                ...
                del_btn_layout.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    # 批量检查重复记录
                    duplicate_check_data = [(record['youth_id'], record['date']) for record in existing_records]
                    cursor.executemany('SELECT youth_id, record_date FROM daily_stat WHERE youth_id = ? AND record_date = ?', duplicate_check_data)
                    existing_daily_records = set((row[0], row[1]) for row in cursor.fetchall())
    ...
    def import_town_interview_files(self):
        """导入镇街谈心谈话文件"""
        try:
            from PyQt6.QtWidgets import QDialog, QVBoxLayout, QHBoxLayout, QLabel, QDateEdit, QPushButton, QFileDialog, QMessageBox
    ...
    def create_physical_examination_tab(self):
        ...
        header.setSectionResizeMode(1, QHeaderView.ResizeMode.ResizeToContents)  # 姓名
        header.setSectionResizeMode(2, QHeaderView.ResizeMode.ResizeToContents)  # 性别
        header.setSectionResizeMode(3, QHeaderView.ResizeMode.Interactive)  # 公民身份号码 - 可手动调整宽度
        header.setSectionResizeMode(4, QHeaderView.ResizeMode.ResizeToContents)  # 应征地
        header.setSectionResizeMode(5, QHeaderView.ResizeMode.ResizeToContents)  # 连
        header.setSectionResizeMode(6, QHeaderView.ResizeMode.ResizeToContents)  # 排
        header.setSectionResizeMode(7, QHeaderView.ResizeMode.ResizeToContents)  # 班
        header.setSectionResizeMode(8, QHeaderView.ResizeMode.ResizeToContents)  # 带训班长信息
        header.setSectionResizeMode(9, QHeaderView.ResizeMode.ResizeToContents)  # 检查阶段
        header.setSectionResizeMode(10, QHeaderView.ResizeMode.ResizeToContents)  # 阳性特征/边缘问题
        header.setSectionResizeMode(11, QHeaderView.ResizeMode.ResizeToContents)  # 日期
        header.setSectionResizeMode(12, QHeaderView.ResizeMode.ResizeToContents)  # 身体状况
        header.setSectionResizeMode(13, QHeaderView.ResizeMode.ResizeToContents)  # 士兵职业基本适应性检测机检类型
        header.setSectionResizeMode(14, QHeaderView.ResizeMode.ResizeToContents)  # 跟踪处置意见
        header.setSectionResizeMode(15, QHeaderView.ResizeMode.ResizeToContents)  # 处置意见落实情况
        header.setSectionResizeMode(16, QHeaderView.ResizeMode.ResizeToContents)  # 查看详情
        header.setSectionResizeMode(17, QHeaderView.ResizeMode.ResizeToContents)  # 删除
        header.setStretchLastSection(False)
        header.setDefaultAlignment(Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignVCenter)
    ...
    def display_physical_examination_results(self, results):
        ...
        for idx, data in enumerate(results):
            ...
            item.setData(Qt.ItemDataRole.TextAlignmentRole, Qt.AlignmentFlag.AlignCenter | Qt.AlignmentFlag.AlignVCenter)
