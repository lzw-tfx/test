    ...
    def load_exception_statistics_data(self):
        ...
        try:
            ...
            for row, record in enumerate(filtered_records):
                ...
                thought_item.setFlags(thought_item.flags() & ~Qt.ItemFlag.ItemIsEditable)
                ...
                body_item.setFlags(body_item.flags() & ~Qt.ItemFlag.ItemIsEditable)
                ...
                spirit_item.setFlags(spirit_item.flags() & ~Qt.ItemFlag.ItemIsEditable)
                ...
                other_item.setFlags(other_item.flags() & ~Qt.ItemFlag.ItemIsEditable)
