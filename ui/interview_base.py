...
class InterviewBase:
    ...
    def _create_table(self):
        ...
        header.setSectionResizeMode(1, QHeaderView.ResizeMode.ResizeToContents)  # 日期列
        header.setSectionResizeMode(2, QHeaderView.ResizeMode.ResizeToContents)  # 姓名列
        header.setSectionResizeMode(3, QHeaderView.ResizeMode.ResizeToContents)  # 性别列
        header.setSectionResizeMode(4, QHeaderView.ResizeMode.ResizeToContents)  # 身份证列
        ...
        header.setSectionResizeMode(10, QHeaderView.ResizeMode.Stretch)  # 思想列自动拉伸
        header.setSectionResizeMode(11, QHeaderView.ResizeMode.ResizeToContents)  # 精神列
        header.setSectionResizeMode(12, QHeaderView.ResizeMode.ResizeToContents)  # 走访调查情况列
        header.setSectionResizeMode(13, QHeaderView.ResizeMode.ResizeToContents)  # 操作列
        header.setSectionResizeMode(14, QHeaderView.ResizeMode.ResizeToContents)  # 删除列
