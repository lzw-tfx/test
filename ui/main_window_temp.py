...
class MainWindow(QMainWindow):
    ...
    def create_town_interview_tab(self):
        ...
        header.setSectionResizeMode(1, QHeaderView.ResizeMode.ResizeToContents)  # 日期�?
        ...
        header.setSectionResizeMode(4, QHeaderView.ResizeMode.Stretch)  # 公民身份号码列自动拉�?
        header.setSectionResizeMode(5, QHeaderView.ResizeMode.ResizeToContents)  # 思想�?
        header.setSectionResizeMode(6, QHeaderView.ResizeMode.ResizeToContents)  # 精神�?
        header.setSectionResizeMode(7, QHeaderView.ResizeMode.Stretch)  # 走访调查情况列自动拉�?
        header.setSectionResizeMode(8, QHeaderView.ResizeMode.ResizeToContents)  # 操作�?
        header.setSectionResizeMode(9, QHeaderView.ResizeMode.ResizeToContents)  # 删除�?
    ...
    def create_exception_statistics_tab(self):
        ...
        header.setSectionResizeMode(QHeaderView.ResizeMode.Stretch)  # 所有列平均分配宽度
        header.setSectionResizeMode(0, QHeaderView.ResizeMode.ResizeToContents)  # 选择�?
        header.setSectionResizeMode(1, QHeaderView.ResizeMode.ResizeToContents)  # 日期�?
        header.setSectionResizeMode(2, QHeaderView.ResizeMode.ResizeToContents)  # 姓名�?
        header.setSectionResizeMode(3, QHeaderView.ResizeMode.ResizeToContents)  # 性别�?
        header.setSectionResizeMode(5, QHeaderView.ResizeMode.ResizeToContents)  # 思想�?
        header.setSectionResizeMode(6, QHeaderView.ResizeMode.ResizeToContents)  # 身体�?
        header.setSectionResizeMode(7, QHeaderView.ResizeMode.ResizeToContents)  # 精神�?
        header.setSectionResizeMode(9, QHeaderView.ResizeMode.ResizeToContents)  # 操作�?
        # 让身份证号码列和异常来源列自动拉伸填充剩余空�?
        header.setSectionResizeMode(4, QHeaderView.ResizeMode.Stretch)  # 公民身份号码�?
        header.setSectionResizeMode(8, QHeaderView.ResizeMode.Stretch)  # 异常来源�?
    ...
    def filter_daily_stats(self):
        ...
        try:
            ...
            header.setSectionResizeMode(QHeaderView.ResizeMode.Interactive)  # 允许手动调整
            header.setSectionResizeMode(0, QHeaderView.ResizeMode.Stretch)  # 公民身份证号码列
            header.setSectionResizeMode(1, QHeaderView.ResizeMode.ResizeToContents)  # 姓名�?
            header.setSectionResizeMode(2, QHeaderView.ResizeMode.ResizeToContents)  # 日期�?
            header.setSectionResizeMode(3, QHeaderView.ResizeMode.ResizeToContents)  # 思想�?
            header.setSectionResizeMode(4, QHeaderView.ResizeMode.ResizeToContents)  # 身体�?
            header.setSectionResizeMode(5, QHeaderView.ResizeMode.ResizeToContents)  # 精神�?
            header.setSectionResizeMode(6, QHeaderView.ResizeMode.ResizeToContents)  # 训练�?
            header.setSectionResizeMode(7, QHeaderView.ResizeMode.ResizeToContents)  # 管理�?
            header.setSectionResizeMode(8, QHeaderView.ResizeMode.Stretch)  # 其他�?
            header.setSectionResizeMode(9, QHeaderView.ResizeMode.ResizeToContents)  # 修改�?
            header.setSectionResizeMode(10, QHeaderView.ResizeMode.ResizeToContents)  # 删除�?
            header.setStretchLastSection(False)
    ...
    def display_town_interview_records(self, records):
        ...
        try:
            ...
            for row, record in enumerate(records):
                ...
                view_image_btn_layout.setAlignment(Qt.AlignmentFlag.AlignCenter)
    ...
    def create_medical_screening_tab(self):
        ...
        header.setSectionResizeMode(4, QHeaderView.ResizeMode.Stretch)  # 筛查情况列自动拉�?
        header.setSectionResizeMode(5, QHeaderView.ResizeMode.ResizeToContents)  # 筛查日期�?
        header.setSectionResizeMode(6, QHeaderView.ResizeMode.ResizeToContents)  # 身体状况�?
        header.setSectionResizeMode(7, QHeaderView.ResizeMode.ResizeToContents)  # 精神状况�?
        header.setSectionResizeMode(8, QHeaderView.ResizeMode.ResizeToContents)  # 操作�?
        header.setSectionResizeMode(9, QHeaderView.ResizeMode.ResizeToContents)  # 删除�?
        header.setStretchLastSection(False)
        header.setDefaultAlignment(Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignVCenter)
    ...
    def import_town_interview_files(self):
        """导入镇街谈心谈话文件"""
        try:
            from PyQt6.QtWidgets import QDialog, QVBoxLayout, QHBoxLayout, QLabel, QDateEdit, QPushButton, QFileDialog, QMessageBox, QProgressBar
